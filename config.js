...
module.exports = {
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://abrahamjoe947:ABASIEMEK@abraham.gmoot.mongodb.net/",
    sessionId: process.env.SESSION_ID || "ZHVh_Queen-Anya_czh_Queen-Anya_yaXY=",
